...
export const gamesData = [
  ...
  },
  {
    ...
    description:
      'A unique puzzle game designed to help players overcome procrastination through engaging gameplay mechanics and psychological insights.',
    longDescription:
      'Procrastinate is an educational puzzle game that addresses the real-world issue of procrastination. Through carefully designed levels and mechanics, players learn productivity techniques while having fun. The game combines entertainment with practical life skills.',
    status: 'Released',
  ...
  },
  {
    ...
    description:
      'You’re stealing gold in a cave with your partner when you realize there’s a massive dragon right next to you! But it’s still asleep.',
    longDescription:
      'You’re stealing gold in a cave with your partner when you realize there’s a massive dragon right next to you! But it’s still asleep.',
    status: 'Prototype',
    category: 'Adventure',
